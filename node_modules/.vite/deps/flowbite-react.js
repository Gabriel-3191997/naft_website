...
import { t as require_classnames } from "./classnames-DMvhEIkt.js";
...
function withoutThemingProps(props) {
	const { theme: theme$1, clearTheme, applyTheme, ...rest } = props;
	return rest;
}
...
*/
var actionsInto = { defaultMerge: actions.defaultMerge };
/**
...
function isEqual(a, b) {
	...
	if (a && b && typeof a === "object" && typeof b === "object") {
		...
		if (Array.isArray(a)) {
			...
			return a.every((item, index$2) => isEqual(item, b[index$2]));
		}
...
var createClassMap$1 = (config) => {
	const { theme: theme$1, prefix } = config;
	const classMap = {
		nextPart: /* @__PURE__ */ new Map(),
		validators: []
	};
	getPrefixedClassGroupEntries(Object.entries(config.classGroups), prefix).forEach(([classGroupId, classGroup]) => {
		processClassesRecursively$1(classGroup, classMap, classGroupId, theme$1);
	});
	return classMap;
};
var processClassesRecursively$1 = (classGroup, classPartObject, classGroupId, theme$1) => {
	classGroup.forEach((classDefinition) => {
		...
		if (typeof classDefinition === "function") {
			if (isThemeGetter$1(classDefinition)) {
				processClassesRecursively$1(classDefinition(theme$1), classPartObject, classGroupId, theme$1);
				return;
			}
		...
		Object.entries(classDefinition).forEach(([key, classGroup$1]) => {
			processClassesRecursively$1(classGroup$1, getPart$1(classPartObject, key), classGroupId, theme$1);
		});
	});
};
...
var createLruCache$1 = (maxCacheSize) => {
	...
	let cacheSize = 0;
	let cache$5 = /* @__PURE__ */ new Map();
	let previousCache = /* @__PURE__ */ new Map();
	const update = (key, value) => {
		cache$5.set(key, value);
		cacheSize++;
		if (cacheSize > maxCacheSize) {
			cacheSize = 0;
			previousCache = cache$5;
			cache$5 = /* @__PURE__ */ new Map();
		}
	};
	return {
		get(key) {
			let value = cache$5.get(key);
		...
		set(key, value) {
			if (cache$5.has(key)) cache$5.set(key, value);
...
var createParseClassName$1 = (config) => {
	...
	const parseClassName = (className) => {
		...
		for (let index$2 = 0; index$2 < className.length; index$2++) {
			let currentCharacter = className[index$2];
			if (bracketDepth === 0) {
				if (currentCharacter === firstSeparatorCharacter && (isSeparatorSingleCharacter || className.slice(index$2, index$2 + separatorLength) === separator)) {
					modifiers.push(className.slice(modifierStart, index$2));
					modifierStart = index$2 + separatorLength;
					continue;
				}
				if (currentCharacter === "/") {
					postfixModifierPosition = index$2;
					continue;
				}
			}
...
var mergeClassList$1 = (classList, configUtils) => {
	...
	*/
	...
	let result = "";
	for (let index$2 = classNames.length - 1; index$2 >= 0; index$2 -= 1) {
		const originalClassName = classNames[index$2];
...
function twJoin$1() {
	...
	let resolvedValue;
	let string = "";
	while (index$2 < arguments.length) if (argument = arguments[index$2++]) {
...
var fromTheme$1 = (key) => {
	const themeGetter = (theme$1) => theme$1[key] || [];
...
var colorFunctionRegex$1 = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/;
...
var sizeLabels$1 = /* @__PURE__ */ new Set([
	"length",
	"size",
	"percentage"
]);
var isArbitrarySize$1 = (value) => getIsArbitraryValue$1(value, sizeLabels$1, isNever$1);
var isArbitraryPosition$1 = (value) => getIsArbitraryValue$1(value, "position", isNever$1);
var imageLabels$1 = /* @__PURE__ */ new Set(["image", "url"]);
var isArbitraryImage$1 = (value) => getIsArbitraryValue$1(value, imageLabels$1, isImage$1);
...
var extendTailwindMerge = (configExtension, ...createConfig) => typeof configExtension === "function" ? createTailwindMerge$1(getDefaultConfig$1, configExtension, ...createConfig) : createTailwindMerge$1(() => mergeConfigs$1(getDefaultConfig$1(), configExtension), ...createConfig);
...
var createClassMap = (config) => {
	const { theme: theme$1, classGroups } = config;
	const classMap = {
		nextPart: /* @__PURE__ */ new Map(),
		validators: []
	};
	for (const classGroupId in classGroups) processClassesRecursively(classGroups[classGroupId], classMap, classGroupId, theme$1);
	return classMap;
};
var processClassesRecursively = (classGroup, classPartObject, classGroupId, theme$1) => {
	classGroup.forEach((classDefinition) => {
		if (typeof classDefinition === "string") {
		...
		if (typeof classDefinition === "function") {
			if (isThemeGetter(classDefinition)) {
				processClassesRecursively(classDefinition(theme$1), classPartObject, classGroupId, theme$1);
				return;
			}
			classPartObject.validators.push({
				validator: classDefinition,
		...
		Object.entries(classDefinition).forEach(([key, classGroup$1]) => {
			processClassesRecursively(classGroup$1, getPart(classPartObject, key), classGroupId, theme$1);
		});
	});
};
		...
		for (let index$2 = 0; index$2 < className.length; index$2++) {
			...
			if (bracketDepth === 0 && parenDepth === 0) {
				if (currentCharacter === MODIFIER_SEPARATOR) {
					modifiers.push(className.slice(modifierStart, index$2));
					modifierStart = index$2 + MODIFIER_SEPARATOR_LENGTH;
					continue;
				}
				if (currentCharacter === "/") {
					postfixModifierPosition = index$2;
...
var createSortModifiers = (config) => {
	...
	const sortModifiers$1 = (modifiers) => {
		if (modifiers.length <= 1) return modifiers;
		const sortedModifiers = [];
		let unsortedModifiers = [];
		modifiers.forEach((modifier) => {
...
var mergeClassList = (classList, configUtils) => {
	const { parseClassName, getClassGroupId, getConflictingClassGroupIds, sortModifiers: sortModifiers$1 } = configUtils;
	/**
	* Set of classGroupIds in following format:
	* `{importantModifier}{variantModifiers}{classGroupId}`
	* @example 'float'
...
var extendTailwindMerge$1 = (configExtension, ...createConfig) => typeof configExtension === "function" ? createTailwindMerge(getDefaultConfig, configExtension, ...createConfig) : createTailwindMerge(() => mergeConfigs(getDefaultConfig(), configExtension), ...createConfig);
...
function resolveTheme([base, ...custom], clearThemeList, applyThemeList) {
	...
	let theme$1 = baseTheme;
	if (_custom?.length) theme$1 = deepMergeStrings(twMerge)(baseTheme, ..._custom);
	if (_applyThemeList?.length && _custom?.length) {
		...
		if (run) runApplyTheme(theme$1, deepmerge(baseTheme, ...custom), finalApplyTheme);
	}
	return theme$1;
}
...
function ThemeProvider({ children, root, props, theme: theme$1, clearTheme, applyTheme }) {
	...
	const value = (0, import_react.useMemo)(() => ({
		...
		theme: !root && parentProvider?.theme ? deepMergeStrings(twMerge)(parentProvider.theme, theme$1) : theme$1,
...
function Accordion(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: twMerge(theme$1.base, theme$1.flush[flush ? "on" : "off"], className),
...
function AccordionContent(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: twMerge(theme$1.base, className),
...
function AccordionTitle(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		className: twMerge(theme$1.base, theme$1.flush[flush ? "on" : "off"], theme$1.open[isOpen ? "on" : "off"], className),
		onClick,
		type: "button",
		...restProps,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading, {
			className: theme$1.heading,
			"data-testid": "flowbite-accordion-heading",
			children
		}), ArrowIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowIcon, {
			"aria-hidden": true,
			className: twMerge(theme$1.arrow.base, theme$1.arrow.open[isOpen ? "on" : "off"]),
...
var Alert = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref,
		className: twMerge(theme$1.base, theme$1.color[color], rounded && theme$1.rounded, withBorderAccent && theme$1.borderAccent, className),
		role: "alert",
		...restProps,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: theme$1.wrapper,
			"data-testid": "flowbite-alert-wrapper",
			children: [
				Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
					className: theme$1.icon,
				...
				typeof onDismiss === "function" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					"aria-label": "Dismiss",
					className: twMerge(theme$1.closeButton.base, theme$1.closeButton.color[color]),
					onClick: onDismiss,
					type: "button",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XIcon, {
						"aria-hidden": true,
						className: theme$1.closeButton.icon
					})
				})
			]
...
var Avatar = (0, import_react.forwardRef)((props, ref) => {
	...
	const { alt = "", bordered = false, children, className, color = "light", img, placeholderInitials = "", rounded = false, size: size$3 = "md", stacked = false, status, statusPosition = "top-left", ...restProps } = resolveProps(props, provider.props?.avatar);
	const imgClassName = twMerge(theme$1.root.img.base, bordered && theme$1.root.bordered, bordered && theme$1.root.color[color], rounded && theme$1.root.rounded, stacked && theme$1.root.stacked, theme$1.root.img.on, theme$1.root.size[size$3]);
	const imgProps = {
		className: twMerge(imgClassName, theme$1.root.img.on),
		"data-testid": "flowbite-avatar-img"
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref,
		className: twMerge(theme$1.root.base, className),
		"data-testid": "flowbite-avatar",
		...restProps,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: theme$1.root.inner,
			children: [img ? typeof img === "string" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				className: twMerge(theme$1.root.img.off, theme$1.root.initials.base, stacked && theme$1.root.stacked, bordered && theme$1.root.bordered, bordered && theme$1.root.color[color], theme$1.root.size[size$3], rounded && theme$1.root.rounded),
				"data-testid": "flowbite-avatar-initials-placeholder",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: twMerge(theme$1.root.initials.text),
					"data-testid": "flowbite-avatar-initials-placeholder-text",
					children: placeholderInitials
				})
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: twMerge(imgClassName, theme$1.root.img.off),
				"data-testid": "flowbite-avatar-img",
				...
				className: twMerge(theme$1.root.status.base, theme$1.root.status[status], theme$1.root.statusPosition[statusPosition])
			})]
...
var Badge = (0, import_react.forwardRef)((props, ref) => {
	...
	const { children, color = "info", icon: Icon, size: size$3 = "xs", className, ...restProps } = resolveProps(props, provider.props?.badge);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		ref,
		className: twMerge(theme$1.root.base, theme$1.root.color[color], theme$1.root.size[size$3], theme$1.icon[Icon ? "on" : "off"], className),
		"data-testid": "flowbite-badge",
		...restProps,
		children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
			"aria-hidden": true,
			className: theme$1.icon.size[size$3],
...
var Banner = (0, import_react.forwardRef)((props, ref) => {
	const mergedProps = resolveProps(props, useThemeProvider().props?.banner);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
...
var Button = (0, import_react.forwardRef)((props, ref) => {
	...
	const { children, className, color = "default", disabled, fullSized, outline: _outline, pill: _pill, size: size$3 = "md", ...restProps } = resolveProps(props, provider.props?.button);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ButtonBase, {
		ref,
		disabled,
		className: twMerge(theme$1.base, theme$1.size[size$3], pill && theme$1.pill, disabled && theme$1.disabled, fullSized && theme$1.fullSized, outline ? theme$1.outlineColor[color] : theme$1.color[color], buttonGroup && theme$1.grouped, className),
		...restProps,
		children
	});
});
...
var Card = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(typeof href === "undefined" ? "div" : "a", {
		...
		href,
		className: twMerge(theme$1.root.base, theme$1.root.horizontal[horizontal ? "on" : "off"], href && theme$1.root.href, className),
		...restProps,
		children: [renderImage?.(theme$1, !!horizontal) ?? (imgSrc && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			"data-testid": "flowbite-card-image",
			alt: imgAlt ?? "",
			src: imgSrc,
			className: twMerge(theme$1.img.base, theme$1.img.horizontal[props.horizontal ? "on" : "off"])
		})), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: theme$1.root.children,
			children
		})]
	});
});
...
var require_debounce = /* @__PURE__ */ __commonJS({ "node_modules/debounce/index.js": ((exports, module) => {
	...
	module.exports.debounce = debounce$1;
...
var Carousel = (0, import_react.forwardRef)((props, ref) => {
	...
	const items = (0, import_react.useMemo)(() => import_react.Children.map(children, (child) => (0, import_react.cloneElement)(child, { className: twMerge(theme$1.item.base, child.props.className) })), [children, theme$1.item.base]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollContainer, {
				className: twMerge(theme$1.scrollContainer.base, (isDeviceMobile || !isDragging) && theme$1.scrollContainer.snap),
				...
				children: items?.map((item, index$2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: theme$1.item.wrapper[draggable ? "on" : "off"],
					"data-active": activeItem === index$2,
					"data-testid": "carousel-item",
					children: item
				}, index$2))
			}),
			indicators && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: theme$1.indicators.wrapper,
				children: items?.map((_, index$2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: twMerge(theme$1.indicators.base, theme$1.indicators.active[index$2 === activeItem ? "on" : "off"]),
					onClick: navigateTo(index$2),
					"data-testid": "carousel-indicator",
					"aria-label": `Slide ${index$2 + 1}`
				}, index$2))
			}),
			items && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: theme$1.root.leftControl,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: leftControl ? leftControl : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DefaultLeftControl, { theme: theme$1.control })
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: theme$1.root.rightControl,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "group",
					...
					children: rightControl ? rightControl : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DefaultRightControl, { theme: theme$1.control })
				})
			})] })
		]
	});
...
function DefaultLeftControl({ theme: theme$1 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: theme$1.base,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeftIcon, { className: theme$1.icon })
	});
}
function DefaultRightControl({ theme: theme$1 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: theme$1.base,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRightIcon, { className: theme$1.icon })
	});
}
...
var Checkbox = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		ref,
		type: "checkbox",
		className: twMerge(theme$1.base, theme$1.color[color], indeterminate && theme$1.indeterminate, className),
		...restProps
	});
});
...
function getDeepestNode(nodes, id) {
	...
	function findDeepest(nodeId, depth) {
		...
		getNodeChildren(nodes, nodeId).forEach((child) => {
...
function isDifferentGridRow(index$2, cols, prevRow) {
	return Math.floor(index$2 / cols) !== prevRow;
}
function isIndexOutOfListBounds(listRef, index$2) {
...
function findNonDisabledListIndex(listRef, _temp) {
	...
	while (index$2 >= 0 && index$2 <= listRef.current.length - 1 && isListIndexDisabled(listRef, index$2, disabledIndices));
	return index$2;
}
...
function createGridCellMap(sizes, cols, dense) {
	...
	sizes.forEach((_ref2, index$2) => {
		...
		if (width > cols) throw new Error("[Floating UI]: Invalid grid - item width at index " + index$2 + " is greater than grid columns");
...
function getGridCellIndexOfCorner(index$2, sizes, cellMap, cols, corner) {
...
function isListIndexDisabled(listRef, index$2, disabledIndices) {
	if (typeof disabledIndices === "function") return disabledIndices(index$2);
	else if (disabledIndices) return disabledIndices.includes(index$2);
	const element = listRef.current[index$2];
...
function getClippingElementAncestors(element, cache$5) {
	const cachedResult = cache$5.get(element);
	if (cachedResult) return cachedResult;
...
function FloatingList(props) {
	...
	const map = import_react.useMemo(() => {
		...
		Array.from(nodes.keys()).sort(sortByDocumentPosition).forEach((node, index$2) => {
...
function useListItem(props) {
	...
	const [index$2, setIndex] = import_react.useState(null);
	const componentRef = import_react.useRef(null);
	const ref = import_react.useCallback((node) => {
		componentRef.current = node;
		if (index$2 !== null) {
			elementsRef.current[index$2] = node;
			if (labelsRef) {
				var _node$textContent;
				const isLabelDefined = label !== void 0;
				labelsRef.current[index$2] = isLabelDefined ? label : (_node$textContent = node == null ? void 0 : node.textContent) != null ? _node$textContent : null;
			}
		}
	}, [
		index$2,
	...
	index(() => {
		const index$3 = componentRef.current ? map.get(componentRef.current) : null;
		if (index$3 != null) setIndex(index$3);
	}, [map]);
	return import_react.useMemo(() => ({
		ref,
		index: index$2 == null ? -1 : index$2
	}), [index$2, ref]);
}
...
var FocusGuard = /* @__PURE__ */ import_react.forwardRef(function FocusGuard$1(props, ref) {
...
var VisuallyHiddenDismiss = /* @__PURE__ */ import_react.forwardRef(function VisuallyHiddenDismiss$1(props, ref) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...props,
		type: "button",
		ref,
...
*/
var FloatingOverlay = /* @__PURE__ */ import_react.forwardRef(function FloatingOverlay$1(props, ref) {
...
function useListNavigation(context, props) {
	...
	const commonOnKeyDown = useEffectEvent((event) => {
		...
		if (cols > 1) {
			...
			const minGridIndex = cellMap.findIndex((index$3) => index$3 != null && !isListIndexDisabled(listRef, index$3, disabledIndices));
			const maxGridIndex = cellMap.reduce((foundIndex, index$3, cellIndex) => index$3 != null && !isListIndexDisabled(listRef, index$3, disabledIndices) ? cellIndex : foundIndex, -1);
			const index$2 = cellMap[getGridNavigatedIndex({ current: cellMap.map((itemIndex) => itemIndex != null ? listRef.current[itemIndex] : null) }, {
				...
				rtl,
				cols,
				disabledIndices: getGridCellIndices([...(typeof disabledIndices !== "function" ? disabledIndices : null) || listRef.current.map((_, index$3) => isListIndexDisabled(listRef, index$3, disabledIndices) ? index$3 : void 0), void 0], cellMap),
...
function Floating({ animation = "duration-300", arrow: arrow$3 = true, children, className, content, placement = "top", style = "dark", theme: theme$1, trigger = "hover", minWidth, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		...getFloatingProps({
			className: twMerge(theme$1.base, animation && `${theme$1.animation} ${animation}`, !open && theme$1.hidden, theme$1.style[style], className),
			style: {
				position: strategy,
				top: y ?? " ",
				left: x ?? " ",
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: theme$1.content,
			children: content
		}), arrow$3 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: twMerge(theme$1.arrow.base, style === "dark" && theme$1.arrow.style.dark, style === "light" && theme$1.arrow.style.light, style === "auto" && theme$1.arrow.style.auto),
			...
			style: {
				...
				right: " ",
				bottom: " ",
				[getArrowPlacement({ placement: floatingProperties.placement })]: theme$1.arrow.placement
			},
			children: "\xA0"
		})]
	})] });
...
function Tooltip(props) {
	...
	const { animation = "duration-300", arrow: arrow$3 = true, children, className, content, placement = "top", style = "dark", trigger = "hover", ...restProps } = resolveProps(props, provider.props?.tooltip);
...
function copyToClipboard(valueToCopy, setIsJustCopied) {
	...
	navigator?.clipboard?.writeText(valueToCopy).then(() => {
		...
		console.error("Failed to Copy text: ", error$1);
...
var ClipboardWithIcon = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: isJustCopied ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, {
			"aria-hidden": true,
			className: theme$1.icon.successIcon
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
			"aria-hidden": true,
			className: theme$1.icon.defaultIcon
		})
	});
});
...
var ClipboardWithIconText = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		children: isJustCopied ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			className: theme$1.label.base,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, {
				"aria-hidden": true,
				className: theme$1.icon.successIcon
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: theme$1.label.successText,
				children: "Copied"
			})]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
				...
				className: theme$1.label.defaultText,
				children: label
			})]
		})
	});
...
var DarkThemeToggle = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconDark, {
			...
			className: twMerge(theme$1.root.icon.base, theme$1.root.icon.dark)
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconLight, {
			"aria-label": "Currently light mode",
			className: twMerge(theme$1.root.icon.base, theme$1.root.icon.light)
		})]
	});
});
...
var TextInput = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [addon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: theme$1.addon,
			children: addon
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: theme$1.field.base,
			children: [
				Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: theme$1.field.icon.base,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: theme$1.field.icon.svg })
				}),
				RightIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"data-testid": "right-icon",
					className: theme$1.field.rightIcon.base,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RightIcon, { className: theme$1.field.rightIcon.svg })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
					className: twMerge(theme$1.field.input.base, theme$1.field.input.colors[color], theme$1.field.input.sizes[sizing], theme$1.field.input.withIcon[Icon ? "on" : "off"], theme$1.field.input.withRightIcon[RightIcon ? "on" : "off"], theme$1.field.input.withAddon[addon ? "on" : "off"], theme$1.field.input.withShadow[shadow ? "on" : "off"]),
					type,
					...restProps,
					ref
				})
...
function getFormattedDate(language, date, options) {
	...
	if (options) defaultOptions$1 = options;
	return new Intl.DateTimeFormat(language, defaultOptions$1).format(date);
}
...
function DatepickerViewsDays() {
	...
	const theme$1 = rootTheme.views.days;
	const weekDays = getWeekDays(language, weekStart);
	const startDate = getFirstDayOfTheMonth(viewDate, weekStart);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: theme$1.header.base,
		children: weekDays.map((day, index$2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: theme$1.header.title,
			children: day
		}, index$2))
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: theme$1.items.base,
		children: [...Array(42)].map((_date, index$2) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				disabled: isDisabled,
				type: "button",
				className: twMerge(theme$1.items.item.base, isToday && theme$1.items.item.today, isSelected && theme$1.items.item.selected, isDisabled && theme$1.items.item.disabled),
				onClick: () => {
...
function DatepickerViewsDecades() {
	...
	const theme$1 = rootTheme.views.decades;
	const first = startOfYearPeriod(viewDate, 100);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: theme$1.items.base,
		children: [...Array(12)].map((_year, index$2) => {
			const year = first - 10 + index$2 * 10;
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				disabled: isDisabled,
				type: "button",
				className: twMerge(theme$1.items.item.base, isSelected && theme$1.items.item.selected, isDisabled && theme$1.items.item.disabled),
				onClick: () => {
					if (isDisabled) return;
...
function DatepickerViewsMonth() {
	...
	const theme$1 = rootTheme.views.months;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: theme$1.items.base,
		children: [...Array(12)].map((_month, index$2) => {
			const newDate = /* @__PURE__ */ new Date();
			newDate.setMonth(index$2, 1);
...
function DatepickerViewsYears() {
	...
	const theme$1 = rootTheme.views.years;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: theme$1.items.base,
		children: [...Array(12)].map((_year, index$2) => {
			const year = startOfYearPeriod(viewDate, 10) + index$2;
			const newDate = new Date(viewDate.getTime());
...
var Datepicker = (0, import_react.forwardRef)((props, ref) => {
	...
	const { title, open, inline: inline$3 = false, autoHide = true, showClearButton = true, labelClearButton = "Clear", showTodayButton = true, labelTodayButton = "Today", defaultValue, minDate, maxDate, filterDate, language = "en", weekStart = WeekStart.Sunday, className, onChange, label, value, ...restProps } = resolveProps(props, provider.props?.datepicker);
	...
	function changeSelectedDate(date, useAutohide) {
		...
		if (autoHide && view === Views.Days && useAutohide == true && !inline$3) setIsOpen(false);
	}
	function clearDate() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DatepickerContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: twMerge(theme$1.root.base, className),
			children: [!inline$3 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextInput, {
				...
				readOnly: true,
				...restProps
			}), (isOpen || inline$3) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: datepickerRef,
				className: twMerge(theme$1.popup.root.base, inline$3 && theme$1.popup.root.inline),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: theme$1.popup.root.inner,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: theme$1.popup.header.base,
							children: [title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: theme$1.popup.header.title,
								children: title
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: theme$1.popup.header.selectors.base,
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										className: twMerge(theme$1.popup.header.selectors.button.base, theme$1.popup.header.selectors.button.prev),
										onClick: () => setViewDate(getViewDatePage(view, viewDate, -1)),
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeftIcon, {})
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										className: twMerge(theme$1.popup.header.selectors.button.base, theme$1.popup.header.selectors.button.view),
										onClick: () => setView(getNextView()),
										children: getViewTitle()
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										className: twMerge(theme$1.popup.header.selectors.button.base, theme$1.popup.header.selectors.button.next),
										onClick: () => setViewDate(getViewDatePage(view, viewDate, 1)),
						...
						(showClearButton || showTodayButton) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [showTodayButton && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								type: "button",
								className: twMerge(theme$1.popup.footer.button.base, theme$1.popup.footer.button.clear),
								onClick: () => {
...
var Drawer = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DrawerContext.Provider, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: twMerge(theme$1.root.base, theme$1.root.position[position][isOpen ? "on" : "off"], edge && !isOpen && theme$1.root.edge, className),
			...restProps,
			children
		}), isOpen && backdrop && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			onClick: () => onClose(),
			className: theme$1.root.backdrop
		})]
	});
});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h5", {
				className: theme$1.inner.titleText,
				id: mainDivId,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TitleIcon, {
					"aria-hidden": true,
					className: theme$1.inner.titleIcon
				}), title]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				className: theme$1.inner.closeButton,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloseIcon$1, {
					"aria-hidden": true,
					className: theme$1.inner.closeIcon
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: theme$1.inner.titleCloseIcon,
					children: "Close menu"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: theme$1.collapsed[isOpen ? "on" : "off"],
...
function Trigger({ refs, children, inline: inline$3, theme: theme$1, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) {
	...
	if (renderTrigger) {
		const triggerElement = renderTrigger(theme$1);
	...
	return inline$3 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		type: "button",
		ref: refs.setReference,
		className: theme$1?.inlineWrapper,
		disabled,
		...a11yProps,
		children
	}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
...
function Dropdown(props) {
	...
	const { placement = restProps.inline ? "bottom-start" : "bottom", trigger = "click", label, inline: inline$3, arrowIcon = true, ...buttonProps } = restProps;
	const dataTestId = restProps["data-testid"] || "flowbite-dropdown-target";
	const handleSelect = (0, import_react.useCallback)((index$2) => {
		setSelectedIndex(index$2);
		setOpen(false);
	}, []);
	const handleTypeaheadMatch = (0, import_react.useCallback)((index$2) => {
		if (open) setActiveIndex(index$2);
		else handleSelect(index$2);
	}, [open, handleSelect]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownContext.Provider, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Trigger, {
			...
			className: twMerge(theme$1.floating.target, className),
			setButtonWidth,
			getReferenceProps,
			renderTrigger,
			children: [label, arrowIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: theme$1.arrowIcon })]
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				"aria-expanded": open,
				...getFloatingProps({ className: twMerge(theme$1.floating.base, theme$1.floating.animation, "duration-100", !open && theme$1.floating.hidden, theme$1.floating.style.auto, className) }),
...
var DropdownDivider = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
		className: twMerge(theme$1.divider, className),
		...restProps
	});
});
...
var DropdownHeader = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
		className: twMerge(theme$1.header, className),
		...restProps
	});
});
...
var DropdownItem = (0, import_react.forwardRef)((props, forwardedRef) => {
	...
	const { ref: listItemRef, index: index$2 } = useListItem({ label: typeof children === "string" ? children : void 0 });
	const ref = useMergeRefs([forwardedRef, listItemRef]);
	const isActive = activeIndex === index$2;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		role: "menuitem",
		className: theme$1.container,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ButtonBase, {
			...
			children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: theme$1.icon }), children]
		})
	});
});
...
var FileInput = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		ref,
		type: "file",
		className: twMerge(theme$1.base, theme$1.colors[color], theme$1.sizes[sizing], className),
		...restProps
	});
});
...
var FloatingLabel = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
			...
			className: twMerge(theme$1.input[color][variant][sizing], className),
			placeholder: " ",
			...
			className: twMerge(theme$1.label[color][variant][sizing], className),
			children: label
		})]
	});
});
...
var Footer = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		...
		className: twMerge(theme$1.root.base, bgDark && theme$1.root.bgDark, container && theme$1.root.container, className),
		...restProps,
		children
	});
});
		...
		children: href ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					alt,
					src,
					className: theme$1.img
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					"data-testid": "flowbite-footer-brand-span",
					className: theme$1.span,
					children: name
				}),
				children
			]
			...
			"data-testid": "flowbite-footer-brand",
			src,
			className: twMerge(theme$1.img, className),
			...restProps
		})
	});
});
...
var FooterIcon = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: href ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
			...
			className: twMerge(theme$1.base, className),
			...restProps,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: theme$1.size })
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
			"data-testid": "flowbite-footer-icon",
			className: theme$1.size,
			...restProps
		})
	});
});
...
var FooterLinkGroup = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
		...
		className: twMerge(theme$1.base, col && theme$1.col, className),
		...restProps
	});
});
...
var HelperText = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		ref,
		className: twMerge(theme$1.root.base, theme$1.root.colors[color], className),
		...restProps
	});
});
...
var HRIcon = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("hr", {
			ref,
			className: twMerge(theme$1.hrLine, className),
			"data-testid": "flowbite-hr-icon",
			role: "separator",
			...restProps
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: theme$1.icon.base,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
				"aria-hidden": true,
				className: theme$1.icon.icon
			})
		})]
	});
});
...
var Label = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
		ref,
		className: twMerge(theme$1.root.base, theme$1.root.colors[color], disabled && theme$1.root.disabled, className),
...
var List = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ordered ? "ol" : "ul", {
		ref,
		className: twMerge(theme$1.base, theme$1.ordered[ordered ? "on" : "off"], unstyled && theme$1.unstyled, nested && theme$1.nested, horizontal && theme$1.horizontal, className),
		...restProps
	});
});
...
var ListItem = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
		ref,
		className: twMerge(theme$1.withIcon[Icon ? "on" : "off"], className),
		...restProps,
		children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: twMerge(theme$1.icon) }), children]
	});
});
...
var ListGroupItem = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
			...
			disabled,
			className: twMerge(theme$1.link.active[isActive ? "on" : "off"], theme$1.link.disabled[disabled ? "on" : "off"], theme$1.link.base, theme$1.link.href[isLink ? "on" : "off"]),
			...restProps,
			children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
				"aria-hidden": true,
				"data-testid": "flowbite-list-group-item-icon",
				className: theme$1.link.icon
			}), children]
		})
	});
});
...
var Navbar = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavbarContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
			ref,
			className: twMerge(theme$1.root.base, theme$1.root.bordered[border ? "on" : "off"], theme$1.root.rounded[rounded ? "on" : "off"], className),
			...restProps,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: twMerge(theme$1.root.inner.base, theme$1.root.inner.fluid[fluid ? "on" : "off"]),
				children
			})
		})
	});
...
var NavbarCollapse = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		className: twMerge(theme$1.base, theme$1.hidden[!isOpen ? "on" : "off"], className),
		...restProps,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			className: theme$1.list,
			children
...
var NavbarLink = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		ref,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
			className: twMerge(theme$1.base, active && theme$1.active.on, !active && !disabled && theme$1.active.off, theme$1.disabled[disabled ? "on" : "off"], className),
			onClick: handleClick,
			...restProps,
			children
		})
...
var Modal = (0, import_react.forwardRef)((props, ref) => {
	...
	const { children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size$3 = "2xl", initialFocus, ...restProps } = resolveProps(props, provider.props?.modal);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModalContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingPortal, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingOverlay, {
				...
				className: twMerge(theme$1.root.base, theme$1.root.positions[position], show ? theme$1.root.show.on : theme$1.root.show.off, className),
				...restProps,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingFocusManager, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						className: twMerge(theme$1.content.base, theme$1.root.sizes[size$3]),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: theme$1.content.inner,
							children
						})
					})
				})
...
var ModalBody = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
		className: twMerge(theme$1.base, popup && theme$1.popup, className),
		...restProps
	});
});
...
var ModalHeader = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
			...
			"aria-label": "Close",
			className: theme$1.close.base,
			type: "button",
			onClick: onClose,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OutlineXIcon, {
				"aria-hidden": true,
				className: theme$1.close.icon
			})
		})]
	});
});
...
var PaginationButton = (0, import_react.forwardRef)(({ active, children, className, onClick, theme: customTheme, clearTheme, applyTheme, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		ref,
		type: "button",
		className: twMerge(active && theme$1.pages.selector.active, className),
		onClick,
		...props,
		children
	});
...
function PaginationNavigation({ children, className, onClick, disabled = false, theme: customTheme, clearTheme, applyTheme, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		type: "button",
		className: twMerge(disabled && theme$1.pages.selector.disabled, className),
		disabled,
		onClick,
		...props,
		children
			...
			children: [
				...
				layout === "pagination" && range(firstPage, lastPage).map((page) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
					...
					children: renderPaginationButton({
						className: twMerge(theme$1.pages.selector.base, currentPage === page && theme$1.pages.selector.active),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PaginationNavigation, {
					className: twMerge(theme$1.pages.next.base, showIcon && theme$1.pages.showIcon),
					onClick: goToNextPage,
					disabled: currentPage === totalPages,
					children: [nextLabel, showIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRightIcon, {
						"aria-hidden": true,
						className: theme$1.pages.next.icon
					})]
				}) })
			]
		})
...
var TablePagination = (0, import_react.forwardRef)((props, ref) => {
	...
	const offset$3 = (currentPage - 1) * itemsPerPage;
	const firstItem = totalItems > 0 ? offset$3 + 1 : 0;
	const lastItem = currentPage === totalPages ? totalItems : offset$3 + itemsPerPage;
	function goToNextPage() {
		onPageChange(Math.min(currentPage + 1, totalPages));
	}
	function goToPreviousPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: theme$1.layout.table.base,
			children: [
				"Showing ",
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: theme$1.layout.table.span,
					children: firstItem
				}),
				" to\xA0",
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function Popover(props) {
	...
	const { children, content, arrow: arrow$3 = true, trigger = "click", initialOpen, open: controlledOpen, onOpenChange: setControlledOpen, placement: theirPlacement = "bottom", ...restProps } = resolveProps(props, provider.props?.popover);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_react.useMemo)(() => {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			...getFloatingProps(),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: theme$1.inner,
				children: [arrow$3 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					style: {
						...
						right: " ",
						bottom: " ",
						[getArrowPlacement({ placement })]: theme$1.arrow.placement
					},
					children: "\xA0"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: theme$1.content,
...
var Progress = (0, import_react.forwardRef)((props, ref) => {
	...
	const { className, color = "default", labelProgress = false, labelText = false, progress, progressLabelPosition = "inside", size: size$3 = "md", textLabel = "progressbar", textLabelPosition = "inside", ...restProps } = resolveProps(props, provider.props?.progress);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref,
		id,
		...
		children: [(textLabel && labelText && textLabelPosition === "outside" || progress > 0 && labelProgress && progressLabelPosition === "outside") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: twMerge(theme$1.base, theme$1.size[size$3], className),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: { width: `${progress}%` },
				className: twMerge(theme$1.bar, theme$1.color[color], theme$1.size[size$3]),
...
var Radio = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		ref,
		type: "radio",
		className: twMerge(theme$1.base, theme$1.color[color], className),
		...restProps
	});
});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
				ref,
				type: "range",
				className: twMerge(theme$1.field.input.base, theme$1.field.input.sizes[sizing]),
				...restProps
			})
		})
	});
...
var Rating = (0, import_react.forwardRef)((props, ref) => {
	...
	const { className, size: size$3 = "sm", ...restProps } = resolveProps(props, provider.props?.rating);
...
var RatingAdvanced = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: theme$1.progress.base,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: theme$1.progress.label,
...
var RatingStar = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, size: size$3 = "sm" } = useRatingContext();
	const provider = useThemeProvider();
	const theme$1 = useResolveTheme([
		ratingTheme.star,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
		...
		className: twMerge(theme$1.sizes[size$3], theme$1[filled ? "filled" : "empty"], className),
		...restProps
	});
});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [addon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				ref,
				className: twMerge(theme$1.field.select.base, theme$1.field.select.colors[color], theme$1.field.select.sizes[sizing], theme$1.field.select.withIcon[Icon ? "on" : "off"], theme$1.field.select.withAddon[addon ? "on" : "off"], theme$1.field.select.withShadow[shadow ? "on" : "off"]),
				...restProps
			})]
		})]
	});
...
var Sidebar = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
			...
			className: twMerge(theme$1.root.base, theme$1.root.collapsed[isCollapsed ? "on" : "off"], className),
			...restProps,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: theme$1.root.inner,
				children
...
var SidebarCollapse = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Wrapper, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			title: label,
			type: "button",
			className: twMerge(theme$1.button, className),
			...restProps,
			children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
				"aria-hidden": true,
				"data-testid": "flowbite-sidebar-collapse-icon",
				className: twMerge(theme$1.icon.base, theme$1.icon.open[isOpen ? "on" : "off"])
			}), isCollapsed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: theme$1.label.title,
				children: label
				...
				className: theme$1.label.base,
				children: label
			}), renderChevronIcon ? renderChevronIcon(theme$1, isOpen) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronIcon, {
				"aria-hidden": true,
				className: twMerge(theme$1.label.icon.base, theme$1.label.icon.open[isOpen ? "on" : "off"])
			})] })]
...
var SidebarItem = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListItem$1, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
			...
			ref,
			className: twMerge(theme$1.base, isActive && theme$1.active, !isCollapsed && isInsideCollapse && theme$1.collapsed.insideCollapse, className),
			...restProps,
			children: [
				Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
					"aria-hidden": true,
					"data-testid": "flowbite-sidebar-item-icon",
					className: twMerge(theme$1.icon.base, isActive && theme$1.icon.active)
				}),
				isCollapsed && !Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: theme$1.collapsed.noIcon,
...
function ListItem$1({ id, theme: theme$1, isCollapsed, tooltipChildren, children: wrapperChildren, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		...props,
...
function Children$1({ id, theme: theme$1, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		"data-testid": "flowbite-sidebar-item-content",
		id: `flowbite-sidebar-item-${id}`,
		className: twMerge(theme$1.content.base),
		children
	});
}
...
var SidebarLogo = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			...
			className: theme$1.collapsed[isCollapsed ? "on" : "off"],
...
var Spinner = (0, import_react.forwardRef)((props, ref) => {
	...
	const { className, color = "default", light, size: size$3 = "lg", ...restProps } = resolveProps(props, provider.props?.spinner);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		ref,
		role: "status",
		...restProps,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			fill: "none",
			viewBox: "0 0 100 101",
			className: twMerge(theme$1.base, theme$1.color[color], theme$1.light[light ? "on" : "off"].base, theme$1.light[light ? "on" : "off"].color[color], theme$1.size[size$3], className),
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
...
var Table = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		className: twMerge(theme$1.root.wrapper),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableContext.Provider, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: twMerge(theme$1.root.shadow, className) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("table", {
				ref,
				className: twMerge(theme$1.root.base, className),
				...restProps
			})]
...
var TableRow = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
		...
		className: twMerge(theme$1.base, striped && theme$1.striped, hoverable && theme$1.hovered, className),
		...restProps
	});
});
...
var Tabs = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			"aria-label": "Tabs",
			role: "tablist",
			className: twMerge(theme$1.tablist.base, theme$1.tablist.variant[variant], className),
			...restProps,
			children: tabs.map((tab, index$2) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				"aria-controls": `${id}-tabpanel-${index$2}`,
				"aria-selected": index$2 === activeTab,
				className: twMerge(theme$1.tablist.tabitem.base, tabItemStyle.base, index$2 === activeTab && tabItemStyle.active.on, index$2 !== activeTab && !tab.disabled && tabItemStyle.active.off),
				disabled: tab.disabled,
				id: `${id}-tab-${index$2}`,
				onClick: () => handleClick({ target: index$2 }),
				onKeyDown: (event) => handleKeyboard({
					event,
					target: index$2
				}),
				ref: (element) => {
					tabRefs.current[index$2] = element;
				},
				role: "tab",
				tabIndex: index$2 === focusedTab ? 0 : -1,
				style: { zIndex: index$2 === focusedTab ? 2 : 1 },
				children: [tab.icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(tab.icon, { className: theme$1.tablist.tabitem.icon }), tab.title]
			}, index$2))
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: twMerge(theme$1.tabitemcontainer.base, tabItemContainerStyle),
			children: tabs.map((tab, index$2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				"aria-labelledby": `${id}-tab-${index$2}`,
				className: theme$1.tabpanel,
				hidden: index$2 !== activeTab,
				id: `${id}-tabpanel-${index$2}`,
				role: "tabpanel",
				tabIndex: 0,
...
var Textarea = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
		ref,
		className: twMerge(theme$1.base, theme$1.colors[color], theme$1.withShadow[shadow ? "on" : "off"], className),
		...restProps
	});
});
...
var Timeline = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TimelineContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
			...
			className: twMerge(horizontal && theme$1.root.direction.horizontal, !horizontal && theme$1.root.direction.vertical, className),
			...restProps
		})
	});
});
...
var TimelineContent = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TimelineContentContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: twMerge(theme$1.root.base, horizontal ? theme$1.root.horizontal : theme$1.root.vertical, className),
			...restProps
		})
	});
});
...
var TimelineItem = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TimelineItemContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
			...
			className: twMerge(horizontal && theme$1.root.horizontal, !horizontal && theme$1.root.vertical, className),
			...restProps
		})
	});
});
...
var TimelinePoint = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		className: twMerge(horizontal && theme$1.horizontal, !horizontal && theme$1.vertical, className),
		...restProps,
		children: [
			children,
			Icon ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: twMerge(theme$1.marker.icon.wrapper),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
					"aria-hidden": true,
					className: twMerge(theme$1.marker.icon.base)
				})
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: twMerge(horizontal && theme$1.marker.base.horizontal, !horizontal && theme$1.marker.base.vertical) }),
			horizontal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: twMerge(theme$1.line) })
		]
	});
});
...
var Toast = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToastContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			role: "alert",
			className: twMerge(theme$1.root.base, durationClasses[duration], isClosed && theme$1.root.closed, className),
			...restProps
		})
	});
});
...
var ToggleSwitch = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		...
		tabIndex: 0,
		type: "button",
		className: twMerge(theme$1.root.base, theme$1.root.active[disabled ? "off" : "on"], className),
		...restProps,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			"data-testid": "flowbite-toggleswitch-toggle",
			className: twMerge(theme$1.toggle.base, theme$1.toggle.checked.color[color], theme$1.toggle.checked[checked ? "on" : "off"], theme$1.toggle.sizes[sizing])
